      ...
      <div className="flex items-center justify-between mb-4 mt-4">
        <div className="">
          <div className="flex items-center justify-between">
            ...
            <div className="text-2xl font-bold text-gray-800 flex space-x-4 ml-8">
              <div>
              <span className="text-sm">Days</span><br/>
                <span>{timeLeft.days}</span>
              </div>
              <div>
              <span className="text-sm">Hours</span><br/>
                <span>{timeLeft.hours}</span>
              </div>
              <div>
              <span className="text-sm">Minutes</span><br/>
                <span>{timeLeft.minutes}</span>
              </div>
              <div>
              <span className="text-sm">Seconds</span><br/>
